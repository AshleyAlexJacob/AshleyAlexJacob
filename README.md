...
Been into engineering sector for past 3 years, i have worked on various platforms and programming languages and frameworks. Out of all those i have worked extensively on flutter for mobile application development, Python/Keras/Tensorflow/SkLearn for different Machine Learning and Deep learning Tasks, plus i have been using AWS for over 2 years, I have explored dockers and complete CI/CD Pipelines.
